        ...
        Account(string data_1, string data_2, int count) {
            ...
            if (data_1 != "0") {
                while (true) {
                    ...
                    if (data_2.length() == 6) {
                        ofstream Username("username.txt", ios::in | ios::out | ios::app);
                        Username << data_1 << endl;
                        Username.close();
                        ofstream Password("password.txt", ios::in | ios::out | ios::app);
                        Password << data_2 << endl;
                        Password.close();
                        ofstream Cart("cart.txt", ios::in | ios::out | ios::app);
                        Cart << "0" << endl;
                        Cart.close();

                        ofstream Cart_junk("junk_cart.txt", ios::in | ios::out | ios::app);
                        Cart_junk << "0" << endl;
                        Cart_junk.close();
                        ...
                        data_2 = "junk_" + data_1 + ".txt";
                        fstream file_2;
                        file_2.open(data_2, ios::in | ios::out | ios::app);
                        file_2.close();

                        ifstream file_in("username.txt");
                        count = 0;
                        while (file_in >> data_1) {
                            count++;
                        }

                        ofstream Member_ID("member_id.txt", ios::in | ios::out | ios::app);
...
void Cart::show_cart(string data_1, string data_2, int count, int choice, const string username, const int pos) {
    if (username != " ") {
        ...
        while (getline(Cart,data_1)) {  
            ...
            ifstream stock_l("stock_list.txt");
            ...
            cout << "\n     Name : " << data_1;
            ifstream stock_v("stock_value.txt");
...
void Cart::recart(string data_1, string data_2, int count, int choice, const string username, const int pos) {
    ofstream junk_cart("junk_cart.txt", ios::trunc);

    ofstream cart_secondary("junk_cart.txt");
    ifstream cart_main("cart.txt");
    ...
    ifstream cart_secon("junk_cart.txt");
    ofstream cart_m("cart.txt");
...
void User::confirm_username(string data_1, string data_2, const string username, const int pos, int count) {
    ...
    if (data_2 == "Y") {
        ofstream junk_second("junk_username.txt", ios::trunc);

        ifstream user_main("username.txt");
        ofstream user_second("junk_username.txt");
        ...
        ofstream junk_main("username.txt", ios::trunc);

        ofstream user_m("username.txt");
        ifstream user_s("junk_username.txt");
...
void User::confirm_password(string data_1, string data_2, const int pos, int count, const string username){
    ...
    if (data_2 == "Y") {
        ofstream junk_second("junk_password.txt", ios::trunc);

        ifstream user_main("password.txt");
        ofstream user_second("junk_password.txt");
        user_main.seekg(0, ios::beg);
        count = 0;
        ...
        ofstream junk_main("password.txt", ios::trunc);

        ofstream user_m("password.txt");
        ifstream user_s("junk_password.txt");
    ...
    if (choice == 1) {
        while (stock >> data_1) {
            ...
            if (data_1[0] == determinants[0]) {
                ...
                ifstream stock_n("stock_list.txt");
